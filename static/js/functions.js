...
function displayBoard(boardObject) {
    ...
    // adds 'delete' buttons
    var btnDelete = $('<button class="btn btn-default btn-xs delboardbutton" title="delete this board and all cards on it"><i class="fa fa-trash" aria-hidden="true"></i></button>')
...
function displayCard(cardObject) {
    ...
    // adds 'delete' buttons
    var btnDelete = $('<button class="btn btn-default btn-xs delcardbutton" title="delete this card"><i class="fa fa-trash" aria-hidden="true"></i></button>')
    btnDelete.on('click', function(){
        var state = new State(new DataBaseImp());
